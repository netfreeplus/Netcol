...
echo -e "$bar1"
    echo -e "${rojo}########################################################${cierre}"
    echo -e "${rojo}#    ${verde}Bienvenido${blanco}, Gracias por utilizar Servicios ${verdeR}NETCOLVIP   ${rojo}# ${cierre}"
    ...
    echo -e "${rojo}#          ${blanco}dev: ${moradoL}@NETCOLVIP${blanco}- ${amarillo}LOS MEJORES ${verdeR}VPN${cierre}           ${rojo}#${cierre}"
    echo -e "${rojo}########################################################${cierre}"
    echo -e "$bar1"
}
...
online (){                                                               
clear
TITLE="${blanco}NETCOLVIP ${verdeR}VPN"
